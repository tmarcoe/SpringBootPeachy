...
public class PettyCashController {
	...
	public String pettyCashSave(@ModelAttribute("pettyCash") PettyCashRegister pettyCashReg, BindingResult result, Principal principal, Model model) throws IOException, ParseException {
