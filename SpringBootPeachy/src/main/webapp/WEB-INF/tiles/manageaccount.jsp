...
<sf:form action="${pageContext.request.contextPath}/vendor/accountdetail" modelAttribute="objectList" method="get" id="accountsListForm"
	name="manageAccounts">
...
<script type="text/javascript">
	function rowRemoved(key) {
		if (confirm("Are you sure you want to remove Account #" + key
				+ " from Chart of Accounts?") == true) {
			window.location.href = "${pageContext.request.contextPath}/vendor/deleteaccount?deleteKey="
					+ key;
		}
	}

	function getDetail(key) {
		window.location.href = "${pageContext.request.contextPath}/vendor/accountdetail?detailKey="
				+ key;
	}
