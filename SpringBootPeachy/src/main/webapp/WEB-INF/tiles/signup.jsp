...
<sf:form id="details" method="post" action="/public/createprofile" commandName="userProfile">
	<table class="signup">
		<thead>
			<tr>
		...
		<tr>
			...
			<td><sf:select path="country">
					...
					<sf:option value="EUR">European Union Euro</sf:option>
		...
		<tr>
			...
			<td><button type="button" onclick="goBack()">Cancel</button></td>
		</tr>
