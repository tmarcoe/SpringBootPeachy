...
<body>
		...
		<tr>
			...
			<c:if test="${principal  != 'anonymousUser'}">
				<td><img alt="Image not available"
					src="<c:url value='/images/scicon.png'/>" width="18" />
					(${total})</td>
			</c:if>
			<td>&nbsp;</td>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			var pg = location.pathname.substring(location.pathname.lastIndexOf("/") + 1); 
		...
		function submitSearch() {
			...
			window.location.href = "${pageContext.request.contextPath}/shopbysearch?mySearch="+srch;
		}
