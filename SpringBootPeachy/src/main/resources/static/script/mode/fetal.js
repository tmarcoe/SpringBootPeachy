...
CodeMirror.defineMode("fetal", function(config, parserConfig) {
  ...
  var keywords = function(){
    ...
    function df(type) {return {type: type, style: "def"};}
  ...
  var atomicTypes = {"number": true, "variable": true, "string": true};
